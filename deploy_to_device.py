...
BINARY_DEPLOY_INFO = {
    "cli": BinaryInstallInformation(
        JB_ROOT_PREFIX / "usr/bin/objsee", Path("src/objsee-cli/objsee-entitlements.xml").resolve()
    ),
    "libobjsee": BinaryInstallInformation(
        JB_ROOT_PREFIX / "usr/lib/libobjsee.dylib",)
}
